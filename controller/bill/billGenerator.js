...
async function generateInvoices() {
  const pMap = (await import('p-map')).default; // Dynamically import `pMap`
    ...
    const invoices = await pMap(
      ...
      async (customer) => {
        try {
          ...
          await Promise.all([invoiceItemPromise, customerUpdatePromise]);
